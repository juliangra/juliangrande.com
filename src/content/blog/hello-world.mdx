...
For now, the fundamentals are solid. The Lighthouse score is sitting at 100/100 on performance, accessibility, and SEO, which is a good place to start.

If you're curious about the source, check it out on [GitHub](https://github.com/juliangra/portfolio). Happy to answer questions — just reach out via the contact page.
